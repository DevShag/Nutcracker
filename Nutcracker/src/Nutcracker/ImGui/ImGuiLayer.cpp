...
namespace Nutcracker {
	...
	void ImGuiLayer::OnAttach()
	{
		...
		//Tempory: should eventually use Nutcracker key code
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<MouseMovedEvent>(NC_BIND_EVENT_FN(ImGuiLayer::OnMouseMoveEvent));
		...
		dispatcher.Dispatch<KeyTypedEvent>(NC_BIND_EVENT_FN(ImGuiLayer::OnKeyTypeEvent));
